                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                            <div>
                                ...
                                <a href="mailto:info@indiaexportwebmart.com" target="_blank">
                                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">info@indiaexportwebmart.com</p>
                                </a>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                                <a href="https://wa.me/+917303899730" target="_blank">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">7656, Gaganpreet Vihar, Naveen Nagar, Haibowal Kalan, Ludhiana, Punjab 141001</p>
                                <h2 className="mt-4 text-base font-medium text-gray-800 dark:text-white">Branch Location</h2>
                                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Block B1/632 , Janakpuri, Delhi, 110058</p>
                            </div>
                            ...
                            <div>
                                ...
                                <a href="tel:+917303899730" target="_blank">
                                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 730-3899-730</p>
                                </a>
                            </div>
                        </div>
